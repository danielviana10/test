...
{
    [DbContext(typeof(MercadinhoContext))]
    [Migration("20231011134501_AzureSqlServer_3")]
    partial class AzureSqlServer_3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mercadinho.Models.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mercadinho.Models.Pedido", b =>
                {
            ...
            modelBuilder.Entity("Mercadinho.Models.Pedido", b =>
                {
                    b.HasOne("Mercadinho.Models.Item", "Item")
                        .WithMany()
